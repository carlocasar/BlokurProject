...
def interaction_with_user(list_all_genres, dict_answer):
...
def main():
    ...
    """ Setup the id's in order to work with the spotify API """
    sp = ms.setup_data("5661f893273a47f7859cf5fc80f77bf6", "3426021191fc4c5baa81e0fec70604e5")
    dict_answer = {}
    dict_answer['artists'] = []
    list_all_genres = []

    """create a dictionarie that contains a list of artists with the following information: Name of the band, genres, top 2 tracks, related artists"""
    ...
    interaction_with_user(list_all_genres, dict_answer)
